    ...
    <div className="space-y-4 ">
          ...
          <div className="space-y-4 text-white ">
            ...
            <div className="home-two-hero-notes ">
              {perspectiveNotes.map((note) => (
                <article key={note.title} className="home-two-hero-note transform transition-transform duration-300 hover:scale-[1.05] hover:shadow-2xl">
          ...
          <div className="grid gap-4">
            <article className="home-two-glass-card">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {proofItems.map((item) => (
                  <article key={item.label} className="home-two-proof-card transform transition-transform duration-300 hover:scale-[1.05] hover:shadow-2xl">
            ...
            <article className="home-two-glass-card  transform transition-transform duration-300 hover:scale-[1.05] hover:shadow-2xl">
              <div className="dashboard-panel-head mb-0 ">
                <div >
          ...
          <div className="service-feature h-full">
            ...
            <div className="grid gap-3">
              {spotlightPoints.map((point) => (
                <article key={point.title} className="preview-card preview-card-cta transform transition-transform duration-300 hover:scale-[1.05] hover:shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {capabilities.map((capability) => (
                <article key={capability.title} className="service-card home-two-service-card transform transition-transform duration-300 hover:scale-[1.05] hover:shadow-2xl">
      ...
      <section className="rounded-[2rem] border services-shell p-3 md:p-4">
        <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
          <article className="service-feature home-two-dark-panel">
            ...
            <div className="grid gap-3">
              {processSteps.map((step) => (
                <article key={step.step} className="home-two-process-card transform transition-transform duration-300 hover:scale-[1.05] hover:shadow-2xl">
                  <span>{step.step}</span>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {sectors.map((sector) => (
              <article key={sector.title} className="service-card home-two-sector-card transform transition-transform duration-400 hover:scale-[1.05] hover:shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {partnershipCards.map((card) => (
              <article key={card.title} className="service-card insight-card transform transition-transform duration-400 hover:scale-[1.05] hover:shadow-2xl">
      ...
      <section className="grid gap-4 lg:grid-cols-[0.88fr_1.12fr]">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {values.map((value) => (
            <article key={value.title} className="service-card insight-card transform transition-transform duration-400 hover:scale-[1.05] hover:shadow-2xl">
